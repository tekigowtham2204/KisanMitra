...
(function () {
    ...
    const translations = {
        ...
        // ── Home Page ──
        'hero.badge': {
            en: '🌱 Open-source · Built for India\'s farmers',
            hi: '🌱 ओपन-सोर्स · भारत के किसानों के लिए',
            te: '🌱 ఓపెన్-సోర్స్ · భారత రైతుల కోసం',
            ta: '🌱 ஓபன்-சோர்ஸ் · இந்திய விவசாயிகளுக்காக',
            mr: '🌱 ओपन-सोर्स · भारतातील शेतकऱ्यांसाठी',
            bn: '🌱 ওপেন-সোর্স · ভারতের কৃষকদের জন্য',
            kn: '🌱 ಓಪನ್-ಸೋರ್ಸ್ · ಭಾರತದ ರೈತರಿಗಾಗಿ',
            gu: '🌱 ઓપન-સોર્સ · ભારતના ખેડૂતો માટે'
        },
        ...
        'common.livePrices': {
            en: 'Data source: public open-data APIs — data.gov.in · eNAM · Agmarknet',
            hi: 'डेटा स्रोत: सार्वजनिक ओपन-डेटा APIs — data.gov.in · eNAM · Agmarknet',
            te: 'డేటా మూలం: పబ్లిక్ ఓపెన్-డేటా APIs — data.gov.in · eNAM · Agmarknet',
            ta: 'தரவு மூலம்: பொது ஓபன்-டேட்டா APIs — data.gov.in · eNAM · Agmarknet',
            mr: 'डेटा स्त्रोत: सार्वजनिक ओपन-डेटा APIs — data.gov.in · eNAM · Agmarknet',
            bn: 'ডেটা সূত্র: পাবলিক ওপেন-ডেটা APIs — data.gov.in · eNAM · Agmarknet',
            kn: 'ಡೇಟಾ ಮೂಲ: ಸಾರ್ವಜನಿಕ ಓಪನ್-ಡೇಟಾ APIs — data.gov.in · eNAM · Agmarknet',
            gu: 'ડેટા સ્રોત: જાહેર ઓપન-ડેટા APIs — data.gov.in · eNAM · Agmarknet'
        },
